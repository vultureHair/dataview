    ...
    methods: {
        ...
        getData() {
            ...
            this.axios
                .get(
                    this.GLOBAL.urlHead +
                        "ModelDetail/GetModelSalesDetail?model=" +
                        this.model +
                        "&dayCount=" +
                        this.dayCount +
                        "&period=" +
                ...
                .then(response => {
                    ...
                    if (response.data.data.length > 0) {
                        this.option.title.text = this.option.title.text =
                            this.model + this_.$t("model.info.lineTitle");
                        // response.data.data[0].model + this_.$t("model.info.lineTitle");
                    }

                    sessionStorage.removeItem("model");
                    sessionStorage.setItem("model", this.model);
                    this.SetLocalStorage(5, this.model, this.model);
                    this.initEcharts();
                })
