    ...
    methods: {
        async getData() {
            ...
            await this.axios
                .get(
                    this.GLOBAL.urlHead +
                        "ProductTotalTendency/GetCategoryGroupSaleInfo?vdoing=4&datetype=1&num=" +
                        this.period
                )
                .then(response => {
            ...
            await this.axios
                .get(
                    this.GLOBAL.urlHead +
                        "ProductTotalTendency/GetCategoryGroupSaleInfo?vdoing=4&datetype=2&num=" +
                        this.period
                )
                .then(response1 => {
            ...
            await this.axios
                .get(
                    this.GLOBAL.urlHead +
                        "ProductTotalTendency/GetCategoryGroupSaleInfo?vdoing=4&datetype=3&num=" +
                        this.period
                )
                .then(response => {
            ...
            //获取产品历史累积销售数据
            await this.axios
                .get(this.GLOBAL.urlHead + "ProductTotalTendency/GetCategoryGroupSaleInfo?vdoing=4")
                .then(response => {
                    this.amount = [];
            ...
            let headLeft = [
                {
                    ...
                    children: [
                        ...
                        { headerName: "model", field: "Name", pinned: "left" }
                    ]
                },
                {
            ...
            var gridOptions = {
                ...
                onRowDoubleClicked: function(event) {
                    window.location.href =
                        "http://data.ivalor.com/#/modelInfo?model=" + event.data.Name;
                }
            };
