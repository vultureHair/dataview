    ...
    methods: {
        ...
        getData() {
            ...
            this.axios
                .get(
                    this.GLOBAL.urlHead +
                        "CustomerInfo/GetCustomerSalesDetail?customer=" +
                        this.customer +
                        "&dayCount=" +
                        this.dayCount +
                        "&period=" +
                ...
                .then(response => {
                    ...
                    if (response.data.data.length > 0) {
                        ...
                        //     response.data.data[0].Bill_to_Customer_No +
                        //     this_.$t("customer.info.lineTitle");
                        this.option.title.text =
                            this.customer + this_.$t("customer.info.lineTitle");
                    }

                    sessionStorage.removeItem("customer");
                    sessionStorage.setItem("customer", this.customer);
                    this.SetLocalStorage(6, this.customer, this.customer);
                    this.initEcharts();
                })
